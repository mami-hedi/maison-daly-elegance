...
export const rooms: Room[] = [
  {
    ...
    fullDescription: "La chambre Khadija vous accueille dans une atmosphère raffinée où le rouge profond se marie harmonieusement avec le blanc immaculé. Dotée d'un lit king-size et d'une salle de bain privative en marbre, cette chambre offre une vue imprenable sur le jardin. Parfaite pour les couples en quête d'intimité et de confort.",
    capacity: 2,
    size: 25,
    price: 120,
  ...
  },
  {
    ...
    fullDescription: "La chambre Ach incarne le minimalisme élégant avec ses lignes pures et ses matériaux nobles. Son design contemporain, rehaussé par des touches de couleur soigneusement choisies, crée une atmosphère zen propice au repos. Grandes fenêtres, lit queen-size et équipements modernes vous attendent.",
    capacity: 2,
    size: 24,
    price: 110,
